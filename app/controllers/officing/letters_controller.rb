  ...
  def create
    ...
    ["1", "2", "3"].each do |document_type|
      ...
      if @residence.save
        ...
        if @residence.document_number.blank? || @residence.errors[:year_of_birth].present? || @residence.errors[:residence_tenant].present? || (not @residence.retrieve_census_data.valid?)
