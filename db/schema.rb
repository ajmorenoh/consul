...
ActiveRecord::Schema.define(version: 20190411090023) do
  ...
  create_table "answers", id: :serial, force: :cascade do |t|
    ...
    t.index ["context"], name: "index_answers_on_context"
  end
  ...
  create_table "budget_polls", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "email"
  ...
  create_table "budget_recommendations", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "investment_id"
    t.integer "budget_id"
    t.datetime "created_at"
    ...
    t.index ["user_id"], name: "index_budget_recommendations_on_user_id"
  end
  ...
  create_table "poll_final_recounts", id: :serial, force: :cascade do |t|
    ...
    t.index ["booth_assignment_id"], name: "index_poll_final_recounts_on_booth_assignment_id"
    t.index ["officer_assignment_id"], name: "index_poll_final_recounts_on_officer_assignment_id"
  end

  create_table "poll_letter_officer_logs", id: :serial, force: :cascade do |t|
    t.string "document_number"
    t.string "message"
    t.integer "user_id"
    t.datetime "created_at"
  ...
  create_table "poll_nvotes", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "poll_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.integer "officer_assignment_id"
    t.integer "booth_assignment_id"
    t.index ["deleted_at"], name: "index_poll_nvotes_on_deleted_at"
    t.index ["user_id"], name: "index_poll_nvotes_on_user_id"
    t.index ["voter_hash"], name: "index_poll_nvotes_on_voter_hash"
  end
  ...
  create_table "probe_options", id: :serial, force: :cascade do |t|
    t.string "code"
    t.string "name"
    t.integer "probe_id"
    ...
    t.index ["debate_id"], name: "index_probe_options_on_debate_id"
  end

  create_table "probe_selections", id: :serial, force: :cascade do |t|
    t.integer "probe_id"
    t.integer "probe_option_id"
    t.integer "user_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["probe_id"], name: "index_probe_selections_on_probe_id"
    t.index ["probe_option_id"], name: "index_probe_selections_on_probe_option_id"
    t.index ["user_id"], name: "index_probe_selections_on_user_id"
  end

  create_table "probes", id: :serial, force: :cascade do |t|
    t.string "codename"
    t.boolean "selecting_allowed", default: true
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["codename"], name: "index_probes_on_codename"
  end
  ...
  create_table "proposals", id: :serial, force: :cascade do |t|
    ...
    t.index ["proceeding"], name: "index_proposals_on_proceeding"
    t.index ["sub_proceeding"], name: "index_proposals_on_sub_proceeding"
  ...
  create_table "redeemable_codes", id: :serial, force: :cascade do |t|
    t.string "token"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["token"], name: "index_redeemable_codes_on_token"
  end
  ...
  create_table "stats", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["namespace", "group"], name: "index_stats_on_namespace_and_group"
    t.index ["namespace"], name: "index_stats_on_namespace"
  end
  ...
  create_table "volunteer_polls", id: :serial, force: :cascade do |t|
    t.string "email"
    t.string "turns"
